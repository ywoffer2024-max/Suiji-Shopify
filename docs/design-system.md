...
| 文档信息 | |
|---|---|
| 版本 | v2.0（高级 UI/UX 重写版，2026-06-11） |
...
| scheme-3 美术馆 | Hero/编辑图/页脚 | `#20232B` | `#F5F5F0` | `#F5F5F0` | `#20232B` | `#F5F5F0` | `#1C1D21` |
...
- **区块节奏**：深浅交替（3→1→5→1→4→3），模拟美术馆展陈反差；相邻同色 scheme 区块间必须有发丝线或 ≥80px 留白。
